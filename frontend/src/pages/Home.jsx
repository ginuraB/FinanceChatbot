...
const Home = () => {
    ...
    if (error) {
        return <div style={{ color: 'red', textAlign: 'center', margin: '20px' }}>Error: {error}</div>;
    }
    ...
    return (
        <div style={{ fontFamily: 'sans-serif', margin: '20px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-around', gap: '20px', flexWrap: 'wrap' }}>
                ...
                <div style={{ flex: '1 1 100%', minWidth: '300px', maxWidth: '100%', order: 1 }}>
                    <ChatInterface userId={CURRENT_USER_ID} />
                </div>

                {/* Removed ExpenseForm and BudgetForm */}
            </div>
